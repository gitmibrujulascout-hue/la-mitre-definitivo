...
// toggleable: true → muestra checkbox "No tiene / No aplica" seleccionado por defecto
export const SALUD_FIELDS = [
  ...
  { key: 'alergias', label: 'Alergias conocidas', placeholder: 'Describí la alergia...', toggleable: true, toggleLabel: 'Sin alergias' },
  { key: 'condicion_medica', label: 'Afección / Enfermedad crónica', placeholder: 'Ej: asma, diabetes, epilepsia...', toggleable: true, toggleLabel: 'Sin afecciones' },
  { key: 'medicacion_habitual', label: 'Medicación habitual', placeholder: 'Nombre y dosis...', toggleable: true, toggleLabel: 'No toma medicación' },
  { key: 'regimen_dietario', label: 'Régimen dietario especial', placeholder: 'Ej: celíaco, vegetariano, sin TACC...', toggleable: true, toggleLabel: 'Sin régimen especial' },
  { key: 'anticoagulacion', label: 'Anticoagulación', placeholder: 'Droga utilizada...', toggleable: true, toggleLabel: 'No está anticoagulado/a' },
  { key: 'salud_mental', label: 'Salud mental', placeholder: 'Diagnóstico o tratamiento relevante...', toggleable: true, toggleLabel: 'Sin tratamiento' },
  { key: 'discapacidad', label: 'Discapacidad / CUD', placeholder: 'N° de certificado o descripción...', toggleable: true, toggleLabel: 'Sin discapacidad' },
