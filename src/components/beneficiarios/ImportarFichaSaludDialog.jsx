...
const SALUD_SCHEMA = {
  ...
  properties: {
    ...
    condicion_medica: { type: 'string', description: 'Enfermedades crónicas o afecciones: asma, diabetes, epilepsia, presión, etc. Null si no tiene.' },
    medicacion_habitual: { type: 'string', description: 'Medicación que toma habitualmente. Null si no toma.' },
    regimen_dietario: { type: 'string', description: 'Régimen alimentario especial: celíaco, vegetariano, sin TACC, etc. Null si no tiene.' },
    anticoagulacion: { type: 'string', description: 'Si está anticoagulado: indicar la droga (ej: "Acenocumarol"). Null si no está.' },
    salud_mental: { type: 'string', description: 'Diagnóstico de salud mental, ataques de pánico, ansiedad, fobias, tratamiento psicológico/psiquiátrico. Null si no tiene.' },
    discapacidad: { type: 'string', description: 'Si tiene CUD (Certificado Único de Discapacidad) o necesidades especiales físicas. Null si no tiene.' },
    ...
    contacto_emergencia_telefono: { type: 'string', description: 'Teléfono del contacto de emergencia (teléfonos de emergencia 1 o 2 del formulario).' },
    contacto_emergencia_relacion: { type: 'string', description: 'Relación del contacto de emergencia (madre, padre, tutor, etc.).' },
    observaciones_salud: { type: 'string', description: 'Otras observaciones médicas relevantes: convulsiones, cirugías recientes, internaciones, transfusiones, presión alta/baja, hemorragias nasales, cualquier dato importante no categorizado arriba.' },
  }
};
...
const FIELD_LABELS = {
  ...
  regimen_dietario: 'Régimen dietario especial',
